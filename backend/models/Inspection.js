...
const inspectionSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum:["payment_created","payment_pending","payment_failed","confirmed","accepted","completed","rejected","cancelled"],
    ...
    paymentStatus: { type: String, enum:["created","pending","paid","failed"], default:"created" },
    razorpayOrderId: { type: String, trim:true, default:"" },
    razorpayPaymentId: { type: String, trim:true, default:"" },
    paymentConfirmedAt: { type: Date, default:null },
    assignmentTriggeredAt: { type: Date, default:null },
